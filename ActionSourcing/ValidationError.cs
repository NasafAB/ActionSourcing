// <copyright file="ValidationError.cs" company="Nasaf AB, Sweden">
...
{
    /// <summary>Inherit from this record to create domain-specific errors that can be returned from
    /// <see cref="IAction{T}.Validate(T, ValidationResult)"/>.</summary>
